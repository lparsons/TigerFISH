...
%fprintf( 'ip.Results.load_results: %d\n', double(ip.Results.load_results) );

%% Calculate or load results
if ip.Results.load_results && exist(exp_data_file, 'file')    %params.load_results ip.Results.load_results
    % Load Results
    tic
