...
for d=1:size(dyes,1)
    ...
    if (~isempty(experiment_spot_data.(dye)))
        ...
        set(histogram.(dye), 'PaperPositionMode', 'manual');
        set(histogram.(dye), 'PaperUnits', 'inches');
        set(histogram.(dye), 'PaperSize',  [10 5] );
        set(histogram.(dye), 'PaperPosition',  [.25 .25 9.5 4.5] );
