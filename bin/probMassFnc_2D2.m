function Y = probMassFnc_2D2( x, y, Folder, File_Name, r )  %, Iter
%
...
spy = round( MAXy/10 );
close all
imagesc( [0 MAXx], [MAXy 0], log2(p_1_2(1:MAXy,1:MAXx)+1) ); 

set(gca, 'Ytick', 0:spy:MAXy, 'YtickLabel', MAXy:-spy:0 );
set(gca, 'Xtick', 0:spx:MAXx, 'XtickLabel', 0:spx:MAXx )
...
set( gca, 'Clim', [0 log2(p_1_2_sorted(end-1))] );
